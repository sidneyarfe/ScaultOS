...
const PROPS_ELEMENTO = {
  ...
  // intensidade 0-1 do painel, nunca CSS livre — mesma fórmula do espelho
  // client-side (textShadowCss em painel/app.js), pra prévia e PNG baterem.
  sombra: (v) => {
    ...
    return `text-shadow:0 ${deslocamento}px ${desfoque}px rgba(0,0,0,${alfa})`;
  },
};
